...
export const STRINGS = {
  he: {
    ...
    sheetStep1: 'פתח גיליון Google חדש.', sheetStep2: 'לחץ על התא הראשון, A1.', sheetStep3: 'הדבק את הנוסחה ולחץ Enter. הלשונית מתמלאת תוך כמה שניות ומתרעננת בערך כל שעה.',
  ...
  en: {
    ...
    sheetStep1: 'Open a new Google Sheet.', sheetStep2: 'Click the first cell, A1.', sheetStep3: 'Paste the formula and press Enter. The tab fills itself within a few seconds and refreshes about every hour.',
