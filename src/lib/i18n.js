...
export const STRINGS = {
  he: {
    ...
    pairLabel: 'מחוברת עם (פרשה כפולה)', pairNone: 'לא מחוברת', statCompletions: 'סה״כ השלמות', sheetTabBooks: 'התקדמות לפי ספר',
    modalDate: 'תאריך', modalSynagogue: 'בית כנסת', modalSynagoguePlaceholder: 'מיקום / בית כנסת',
    pesukim: 'פסוקים', usualRange: 'הטווח הרגיל', customRange: 'טווח פסוקים אחר (הוספה, או עלייה שחולקה השבוע)', customRangeHint: 'כבוי = הטווח הרגיל של העלייה הזו.',
    fromPerek: 'מפרק', fromPasuk: 'פסוק', toPerek: 'עד פרק', toPasuk: 'פסוק', rangeIncomplete: 'מלא את ארבעת המספרים.', rangeOutside: 'אין פרק או פסוק כזה בספר הזה.', rangeOrder: 'הסוף לפני ההתחלה.',
    extraHint: 'הוספה: הזן מאיפה עד איפה קראו לך.', isExtra: 'עלייה נוספת (הוספה): לא נספרת ב״כל העליות״, ותמיד עם טווח פסוקים משלה',
    extraTag: 'הוספה', statPesukimTotal: 'פסוקים בכל העליות', statTorahCovered: 'פסוקים שונים מהתורה', ofTorah: 'מהתורה',
    perekLengths: 'מספר פסוקים בכל פרק', perekLengthsHint: 'מופרד בפסיקים, פרק אחרי פרק. נדרש כדי לספור פסוקים בעליות.',
    ...
    section: 'חלק', noSection: 'ללא חלק', aliyahRanges: 'מאיפה עד איפה כל עליה (פרק:פסוק)', from: 'מ', to: 'עד',
    ...
    sheetTitle: 'גיליון Google חי', sheetIntro: 'הדבק נוסחה אחת בגיליון Google חדש. הגיליון מתמלא לבד בכל מה שלמדת ובכל עלייה שקיבלת: כמה פעמים, ומתי. Google מרענן אותו בערך כל שעה.',
    ...
    sheetHow: 'כל נוסחה מקבלת לשונית משלה: לחץ על התא הראשון (A1) של לשונית חדשה והדבק.',
    sheetTabStudy: 'כל השלמה בנפרד', sheetTabAliyos: 'עליות בלבד', sheetTabParashah: 'לפי פרשה', sheetTabAll: 'הכל בלשונית אחת',
    sheetStep2: 'לחץ על התא הראשון, A1.', sheetStep3: 'הדבק את הנוסחה ולחץ Enter. הלשונית מתמלאת תוך כמה שניות ומתרעננת בערך כל שעה.',
    sheetOpenNew: 'פתח גיליון Google חדש', sheetMore: 'עוד תצוגות (לא חובה, לשונית לכל אחת)', sheetDates: 'תאריכים מופיעים כטקסט עם התאריך העברי לידם, למשל 2026-09-06 · כ״ד אלול תשפ״ו.',
    ...
    sheetYourLink: 'הקישור הסודי שלך', sheetTemplateBtn: 'פתח את תבנית הגיליון (יוצר עותק אצלך)', sheetTemplateHow: 'בעותק שנפתח, הדבק את הקישור שלך בתא הצהוב בלשונית Setup. כל הלשוניות יתמלאו לבד ויתעדכנו כל שעה.',
  ...
  en: {
    ...
    pairLabel: 'Connected with (double parashah)', pairNone: 'Not connected', statCompletions: 'Total completions', sheetTabBooks: 'Progress by sefer',
    modalDate: 'Date', modalSynagogue: 'Synagogue', modalSynagoguePlaceholder: 'Location / Synagogue',
    pesukim: 'pesukim', usualRange: 'Usual range', customRange: 'Different pesukim (a hosafah, or the aliyah was split that week)', customRangeHint: 'Off = the usual range of this aliyah.',
    fromPerek: 'From perek', fromPasuk: 'pasuk', toPerek: 'To perek', toPasuk: 'pasuk', rangeIncomplete: 'Fill in all four numbers.', rangeOutside: 'That perek or pasuk does not exist in this sefer.', rangeOrder: 'The end comes before the start.',
    extraHint: 'Hosafah: enter where your reading started and ended.', isExtra: 'Extra aliyah (hosafah): not counted in "all aliyos", and always has its own pesukim range',
    extraTag: 'extra', statPesukimTotal: 'Pesukim across all aliyos', statTorahCovered: 'Different pesukim of the Torah', ofTorah: 'of the Torah',
    perekLengths: 'Pesukim in each perek', perekLengthsHint: 'Comma separated, one number per perek. Needed to count the pesukim of aliyos.',
    ...
    section: 'Section', noSection: 'No section', aliyahRanges: 'Where each aliyah starts and ends (perek:pasuk)', from: 'From', to: 'To',
    ...
    sheetTitle: 'Live Google Sheet', sheetIntro: 'Paste one formula into a new Google Sheet. The sheet fills itself with everything you learned and every aliyah you received: how many times, and when. Google refreshes it about once an hour.',
    ...
    sheetHow: 'Each formula gets its own tab: click the first cell (A1) of a new tab and paste.',
    sheetTabStudy: 'Every single completion', sheetTabAliyos: 'Aliyos only', sheetTabParashah: 'By parashah', sheetTabAll: 'Everything in one tab',
    sheetStep2: 'Click the first cell, A1.', sheetStep3: 'Paste the formula and press Enter. The tab fills itself within a few seconds and refreshes about every hour.',
    sheetOpenNew: 'Open a new Google Sheet', sheetMore: 'More views (optional, one tab each)', sheetDates: 'Dates appear as text with the Hebrew date next to them, for example 2026-09-06 · 24 Elul 5786.',
    ...
    sheetYourLink: 'Your secret link', sheetTemplateBtn: 'Open the sheet template (makes your own copy)', sheetTemplateHow: 'In the copy that opens, paste your link into the yellow cell on the Setup tab. Every tab fills itself and refreshes about every hour.',
